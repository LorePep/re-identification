...
def get_dataloaders(df_train, df_val, train_path, sampler=None, img_size=224, mean=DEFAULT_RESNET_MEAN, std=DEFAULT_RESNET_STD, batch_size=16):
    ...
    if sampler:
        train_dataloader = DataLoader(single_train_dataset,
                num_workers=4,
